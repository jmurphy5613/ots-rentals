        ...
        <>
            ...
            <div className={styles.container}>
                ...
                <div className={styles.description}>
                    ...
                    <h4 className={styles["item-description"]}>
                        {currentCamera.description}
                    </h4>
                    <h2 className={styles.price}>
                        ${currentCamera.price}/week
                    </h2>
                    <div style={{ display: "flex" }}>
                        ...
                        {currentCamera.returnDate < Date.now() ? (
                            <button
                                ...
                                */
                                    const currentItems: Array<Object> =
                                        cart.items;
                                    const currentItem = {
                                        gear: currentCamera,
                            ...
                            <button className={styles["add-to-cart"]} disabled>
                                Out of Stock
                            </button>
                        )}
                    </div>
